...
<div class="ht_content_rightnr">
    ...
    <div class="ht_sub_nr1">
        <h4 class="ht_sub_title0"><img src="${basePath}/manage/images/ht_ico06.png" /><p>增加</p></h4>
...
">
           ...
           <div class="clear"></div> <p>权限设置：</p>
            ...
            <span onClick="mask.style.visibility='visible';massage_box.style.visibility='visible'" style="cursor:hand"><a href="#"><img src="${basePath}/manage/images/ht_ico07.jpg" class="ht_img1" /></a></span>
...
//            }
        ...
        $.ajax({
            url: "/role/ajaxrolenameexist?roleName="+$("#rolename").val(),
