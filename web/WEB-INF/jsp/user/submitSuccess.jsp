...
<div class="ht_content_rightnr">
    <div class="ht_yemei">
        <p>您当前所在位置：<a href="#">首页</a> >> <a href="#">个人中心</a> >> <span>问题解答</span></p>
    </div>
    ...
    <div class="ht_sub_nr1">
        ...
        <span class="ht_sub_span2"><img src="${basePath}/manage/images/ht_ico011.gif"/>
            <p>问题提交成功，我们将尽快解答。</p></span>

        <input type="button" onclick="javascript:location.href='${basePath}/home' ;" value="返回" class="ht_but_qd1" style="margin-left: 160px"/>
        <div class="clear"></div>
